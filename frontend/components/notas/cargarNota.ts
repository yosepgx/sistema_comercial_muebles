...
import { z } from "zod";
import { TNota } from "../types/nota";
import { formNotaSchema } from "../schemas/formNotaSchema";

export const cargarNota = (pedido: TNota, form: UseFormReturn<z.infer<typeof formNotaSchema>>) =>{
